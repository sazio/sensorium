...
#from sensorium.sensorium.models.CapsNet import CapsuleNetwork ## for RotationEquivariant2dCore 
...
from .vonenet import VOneNet #TransferLearningCore

def VOneNet_core_full_gauss_readout(
    dataloaders,
    seed,
    hidden_channels=32,
    input_kern=13,
    ...
    complex_chs = 256 #128 #64 # so far 256 is the best 
    simple_chs = complex_chs
    core_input_channels = complex_chs + simple_chs

    #core = TransferLearningCore(input_channels = 1, layers = 3, fine_tune = True)
    core = nn.Sequential(VOneNet(model_arch = "block", image_size = (144, 256), visual_degrees = 3.8, 
       complex_channels = complex_chs , simple_channels = simple_chs, stride = 4), 
...
def VOne_SE_core_full_gauss_readout(
    dataloaders,
    seed,
    hidden_channels=32,
    input_kern=13,
